...
class Phase3(player.Player):
  ...
  def opponent_model_update_array (self, highest_bet, pot, players, position, shared_cards, state, total_raises, active_players):
    ...
    for k, v in self.calculated_opponent_models.items():
  ...
  def take_action(self, highest_bet, pot, players, position, shared_cards, state, total_raises, active_players):
    ...
    print("------------------------------------------- TESTDATA FOR CALCULATED OPPONENT 1 ----------------------------------------- ")
    print(self.calculated_opponent_models)
    print(in_checker)
    ...
    print("------------------------------------------- TESTDATA FOR CALCULATED OPPONENT ----------------------------------------- ")
    print(self.calculated_opponent_models)
...
players = [
  ...
  phase2.Phase2("Martin", 1000, "loose_aggressive")
...
p = poker.poker(players, 10, debug_mode = True);
